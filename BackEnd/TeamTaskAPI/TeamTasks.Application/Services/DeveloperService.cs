...
namespace TeamTasks.Application.Services
{
    public class DeveloperService : IDeveloperService
    {
        ...
        public DeveloperService(IDeveloperRepository developerRepository) => _developerRepository = developerRepository;
        ...
        public async Task<Result<IEnumerable<DeveloperDto>>> GetActiveDevelopersAsync()
        {
            ...
            var dtos = developers.Select(d => new DeveloperDto(d.DeveloperId, d.FullName, d.Email));
